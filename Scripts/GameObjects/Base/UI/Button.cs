...
namespace MonoGame_Core.Scripts
{
    ...
    {
        public Button(string deselectedTexture, string selectedTexture, string name, Vector2 pos, byte layer, BehaviorHandler.Act onClick, Component[] onClickComponents = null) : base(deselectedTexture, name, new string[] { "button" }, pos, layer)
        {
            ...
            if (onClick != null)
                behaviorHandler.Add("OnClick", onClick, onClickComponents);
        }
    }
}
