...
namespace MonoGame_Core.Scripts
{
    ...
    {
        public TestObject(string texID, string tag) : base(texID, tag, new Vector2(40,40), new Vector2(40,40))
        {
            ...
            ComponentHandler.AddComponent(new FontRenderer("Test", "TestFont", Transform, new Vector2(0, 100), new Vector2(1920,1080),1,0,Color.Red,1));
