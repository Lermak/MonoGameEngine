...
namespace MonoGame_Core.Scripts
{
    public class Pong : Scene
    {
        protected override void loadContent()
        {
            ...
            GameObjects.Add("Ball", new Ball("Ball", "Ball", new Vector2(), new Vector2(40, 40)));
            GameObjects.Add("Player", new PlayerPaddle("Paddle", "Player", new Vector2(40,120), new Vector2(60 - RenderingManager.WIDTH / 2, 0)));
            GameObjects.Add("AI", new AIPaddle("Paddle", "AI", new Vector2(40, 120), new Vector2(RenderingManager.WIDTH / 2 - 60, 0)));
        }
    }
}
